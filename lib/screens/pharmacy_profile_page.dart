    ...
    final confirmed = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            Text(
              'Eczanenizi ve hesabınızı kalıcı olarak silmek istiyorsanız aşağıya "onaylıyorum" yazın.',
              style: TextStyle(color: isDark ? Colors.white70 : Colors.black87),
            ),
            const SizedBox(height: 8),
            Text(
              'Bu işlem geri alınamaz. Tüm stoklar, sipariş geçmişi ve eczane verileri silinecektir.',
