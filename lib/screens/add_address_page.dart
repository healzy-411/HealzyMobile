...
class _AddAddressPageState extends State<AddAddressPage> {
  ...
  final _title = TextEditingController(text: "Ev");
  final _fullName = TextEditingController();
  final _phone = TextEditingController();

  // Ankara sabit
  final _city = TextEditingController(text: "Ankara");
  ...
  // ✅ yeni alan
  final _addressDescription = TextEditingController();
  ...
  Future<AddressDto> _createAddress() async {
    final uri = Uri.parse("${widget.baseUrl}/api/addresses");
    ...
    String msg = "Adres eklenemedi (${res.statusCode})";
    try {
  ...
  Future<void> _submit() async {
    ...
    try {
      final created = await _createAddress();
      if (!mounted) return;
